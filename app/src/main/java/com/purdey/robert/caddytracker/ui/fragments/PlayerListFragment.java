...
import com.purdey.robert.caddytracker.ui.adapters.PlayerArrayAdapter;
 ...
 */
public class PlayerListFragment extends EntityListFragment<Player>
{
	/**
	...
	@Override
	protected ArrayList<Player> getEntities()
	{
		return Lists.newArrayList(playerService.findAll() );
	}
	...
	{
		return R.id.select_player_list_view;
	}

	@Override
	protected EntityArrayAdapter<Player, PlayerViewHolder> getEntityAdapter(ArrayList<Player> entities)
	{
		return new PlayerArrayAdapter(getActivity(), entities);
	}
